...
class SpreadTakerAlgo(SpreadAlgoTemplate):
    ...
    def hedge_passive_leg(self):
        ...
        self.write_log("algo hedge_passive_leg, active_traded=%s" % active_traded)
    ...
    def send_leg_order(self, vt_symbol: str, leg_volume: float):
        ...
        if leg_volume > 0:
            ...
            if vt_symbol == self.spread.active_leg.vt_symbol:
                ...
                price = round_to(self.spread.passive_leg.bid_price - leg_contract.pricetick * self.payup,leg_contract.pricetick)
