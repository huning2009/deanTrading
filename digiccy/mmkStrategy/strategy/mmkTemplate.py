...
class MmkTemplate(object):
    ...
    def buy(self, price, volume, stop=False):
        """买开"""
        return self.sendOrder(MMKORDER_BUY, price, volume, stop)
    
    #----------------------------------------------------------------------
    def sell(self, price, volume, stop=False):
        """卖平"""
        return self.sendOrder(MMKORDER_SELL, price, volume, stop)       

    #----------------------------------------------------------------------
    def short(self, price, volume, stop=False):
        """卖开"""
        return self.sendOrder(MMKORDER_SHORT, price, volume, stop)          
 
    #----------------------------------------------------------------------
    def cover(self, price, volume, stop=False):
        """买平"""
        return self.sendOrder(MMKORDER_COVER, price, volume, stop)
    ...
    def sendOrder(self, orderType, price, volume, stop=False):
        ...
        if self.trading:
            ...
            if stop:
                vtOrderIDList = self.mmkEngine.sendStopOrder(self.vtSymbol, orderType, price, volume, self)
            else:
                vtOrderIDList = self.mmkEngine.sendOrder(self.vtSymbol, orderType, price, volume, self) 
